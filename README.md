...
This project was developed as part of the PROG6212 coursework and incorporates lecturer feedback to enhance usability, version control, and project documentation.
